...
public class FindHidden : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // 메시지 오브젝트 설정
        msg_congrate = GameObject.Find("FindHiddenCanvas/msg_congrate");
        msg_retry = GameObject.Find("FindHiddenCanvas/msg_retry");
        ...
        // 씬의 오브젝트를 불러옴
        btn_option_1 = GameObject.Find("FindHiddenCanvas/btn_option_1");
        btn_option_2 = GameObject.Find("FindHiddenCanvas/btn_option_2");
        btn_option_3 = GameObject.Find("FindHiddenCanvas/btn_option_3");
        btn_option_4 = GameObject.Find("FindHiddenCanvas/btn_option_4");

        img_answer_1 = GameObject.Find("FindHiddenCanvas/img_sketch_background/img_answer_1");
        img_answer_2 = GameObject.Find("FindHiddenCanvas/img_sketch_background/img_answer_2");
        img_answer_3 = GameObject.Find("FindHiddenCanvas/img_sketch_background/img_answer_3");
        img_answer_4 = GameObject.Find("FindHiddenCanvas/img_sketch_background/img_answer_4");
